...
INSERT INTO `authority` VALUES ('70', '1', '0', '发票管理', '70', '0', '1', '/financial/invoice', '/financial/invoice', '', null);
INSERT INTO `authority` VALUES ('71', '1', '0', '发票列表', '70,71', '0', '1', '/financial/invoice', '/financial/invoice', '', '70');
...
-- Records of role
-- ----------------------------
INSERT INTO `role` VALUES ('1', '25', '系统管理员', '0');
...
CREATE TABLE `t_invoicedetail` (
  ...
  `invoiceId` varchar(20) COLLATE utf8_bin NOT NULL,
  `factoryId` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `sumprice` decimal(10,0) DEFAULT NULL COMMENT '一个物品的总金额',
  `status` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `createTime` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `note` varchar(1024) COLLATE utf8_bin DEFAULT NULL,
  `invoicedetailId` varchar(255) COLLATE utf8_bin NOT NULL,
...
-- ----------------------------
INSERT INTO `t_invoicedetail` VALUES ('1', '0', '0', 'S20171203172351', null, null, '未完成', null, '', 'S20171203172351D172432', 'G001', '大螺丝', '1000', '0.1', '100');
INSERT INTO `t_invoicedetail` VALUES ('2', '0', '0', 'S20171203172351', null, null, '未完成', null, '', 'S20171203172351D172602', 'M0019', '大螺丝', '1000', '0.2', '200');
INSERT INTO `t_invoicedetail` VALUES ('3', '0', '0', 'S20171203172351', null, null, '未完成', null, '', 'S20171203172351D172602', 'M0019', '大螺丝', '1000', '0.2', '200');
INSERT INTO `t_invoicedetail` VALUES ('4', '0', '0', 'S20171203172351', null, null, '未完成', null, '', 'S20171203172351D172602', 'G001', '大螺丝', '1000', '0.1', '100');
...
CREATE TABLE `t_prepare` (
  ...
  `version` int(11) NOT NULL DEFAULT '1',
  `enable` tinyint(1) NOT NULL DEFAULT '0',
  `prepareId` varchar(20) COLLATE utf8_bin NOT NULL,
  ...
  `status` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `note` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `receivePers` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `receiveAddr` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `createTime` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `t_preparedetail` (
  ...
  `version` int(11) NOT NULL DEFAULT '1',
  `enable` tinyint(1) NOT NULL DEFAULT '0',
  `preparedetailId` varchar(20) COLLATE utf8_bin NOT NULL,
  `factoryId` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `prepareId` varchar(20) COLLATE utf8_bin DEFAULT NULL COMMENT '一个物品的总金额',
  `status` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `size` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `note` varchar(1024) COLLATE utf8_bin DEFAULT NULL,
  `preparePers` varchar(50) COLLATE utf8_bin NOT NULL,
  `productId` varchar(255) COLLATE utf8_bin NOT NULL,
  `productName` varchar(255) COLLATE utf8_bin NOT NULL,
  `amount` int(11) NOT NULL,
  PRIMARY KEY (`id`)
