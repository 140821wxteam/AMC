...
<body class="page-header-fixed">
							...
							<div class="row">
							   <div class="col-md-6">
								  <div class="form-group">
									 <label class="control-label col-md-3">缺货通知单编号</label>
									 <div class="col-md-9">
										<form:input path="backorderId" class="form-control placeholder-no-fix" autocomplete="off" placeholder="缺货通知单编号"/>
									 </div>
								  </div>
							   </div>
							   <!--/span-->
							   <div class="col-md-6">
								  <div class="form-group">
									 <label class="control-label col-md-3">配件编号</label>
									 <div class="col-md-9">
										<form:input path="productId" class="form-control placeholder-no-fix" autocomplete="off" placeholder="配件编号"/>
									 </div>
								  </div>
							   </div>
							   <!--/span-->
                  ...
                  <div class="portlet-body">
                     ...
                     <div class="dataTables_wrapper form-inline" role="grid">
	                     ...
	                     <c:import url = "../shared/paging.jsp">
	        				...
	        				<c:param name="urlAddress" value="/backoder/backorder"/>
	       				 </c:import>
       				 </div>
                  </div>
               </div>
  ...
  <script type="text/javascript">
         ...
         $(".table-toolbar").toolbarLite({
             items: [
            	 { link: true, display: "新增缺货单", css: "icon-plus", showIcon: true, url: "<%=UrlHelper.resolveWithReturnUrl("/backoder/backorderaddnew", request.getAttribute("requestUrl"), request.getAttribute("requestQuery"), pageContext)%>" },
                 { splitter: true }, 
                 ...
                 { splitter: true },                  
                 { link: true, display: "缺货到达", css: "icon-trash", showIcon: true, url: "<%=UrlHelper.resolveWithReturnUrl("/basedata/productdelete/{0}", request.getAttribute("requestUrl"), request.getAttribute("requestQuery"), pageContext)%>", 
