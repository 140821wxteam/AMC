                     ...
                     <form:form modelAttribute="contentModel" class="form-horizontal" method="POST">
                        <div class="form-body">
                           <div class="form-group">
                              <label  class="col-md-2 control-label">进货单编号</label>
                              <div class="col-md-10">
                                 <form:input path="stockinId" class="form-control" placeholder="进货单编号"/>
                              </div>
                           </div>
                           <div class="form-group">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-md-10">
                                 <form:input path="amount" class="form-control" placeholder="数量"/>
                              </div>
                           </div>
                           <div class="form-group">
                              <label  class="col-md-2 control-label">供应商编号</label>
                              <div class="col-md-10">
                                 <form:select path="vendorId" id="vendorId" class="form-control">
									<form:option value="" disabled="disabled">请选择供应商编号</form:option>
