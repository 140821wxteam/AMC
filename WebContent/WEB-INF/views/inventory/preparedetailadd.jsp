                  ...
                  <div class="portlet-body form">
                     <form:form modelAttribute="contentModel" class="form-horizontal" method="POST">
                        <div class="form-body">
                           ...
                           <div class="form-group">
                              <label  class="col-md-2 control-label">配件编号</label>
                              <div class="col-md-10">
                                 <form:input path="productId" name="productId" class="form-control" placeholder="配件编号"/>                               
                              </div>
                           </div>
                           <div class="form-group">
                              <label  class="col-md-2 control-label">配件名称</label>
                              <div class="col-md-10">
                                 <form:input path="productName" name="productName" class="form-control" placeholder="配件名称"/>                               
                              </div>
                           </div>
                           <div class="form-group">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-md-10">
                                 <form:input path="amount" name="amount" id="amount" class="form-control" placeholder="需求数量" onchange="figure()"/>
                              </div>
                           </div>
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-md-10">
                                 <form:input path="size" name="size" id="size" class="form-control" placeholder="规格" onchange="figure()"/>
                              </div>
                           </div>
                           <div class="form-group">
                              <label  class="col-md-2 control-label">备货人</label>
                              <div class="col-md-10">
                                 <form:input path="preparePers" name="preparePers" id="preparePers" class="form-control" placeholder="备货人"/>
                              </div>
                           </div>
                           <div class="form-group">
