							...
							<div class="row">
							   <div class="col-md-6">
								  <div class="form-group">
									 ...
									 <div class="col-md-9">
										<form:input path="prepareId" class="form-control placeholder-no-fix" autocomplete="off" placeholder="备货单编号"/>
									 </div>
								  </div>
							   </div>
							   <!--/span-->
                  ...
                  <div class="portlet-body">
                     ...
                     <div class="dataTables_wrapper form-inline" role="grid">
	                     ...
	                     <c:import url = "../shared/paging.jsp">
	        				...
	        				<c:param name="urlAddress" value="/inventory/prepare"/>
	       				 </c:import>
       				 </div>
                  </div>
               </div>
