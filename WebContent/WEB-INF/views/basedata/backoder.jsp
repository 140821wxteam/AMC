							...
							<div class="row">
							   <div class="col-md-6">
								  <div class="form-group">
									 <label class="control-label col-md-3">缺货单编号</label>
									 <div class="col-md-9">
										<form:input path="customerId" class="form-control placeholder-no-fix" autocomplete="off" placeholder="缺货单编号"/>
									 </div>
								  </div>
							   </div>
							   <!--/span-->
							   <div class="col-md-6">
								  <div class="form-group">
									 <label class="control-label col-md-3">缺货单名称</label>
									 <div class="col-md-9">
										<form:input path="customerName" class="form-control placeholder-no-fix" autocomplete="off" placeholder="缺货单名称"/>
									 </div>
								  </div>
							   </div>
							   <!--/span-->
