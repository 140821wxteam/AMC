                     ...
                     <form:form modelAttribute="contentModel" class="form-horizontal" method="POST">
                        <div class="form-body">
                           <div class="form-group">
                              ...
                              <div class="col-md-10">
                                 <form:input path="customerId" class="form-control" placeholder="顾客编号"/>
                              </div>
                           </div>
                           <div class="form-group">
                              <label  class="col-md-2 control-label">顾客名称</label>
                              <div class="col-md-10">
                                 <form:input path="customerName" class="form-control" placeholder="顾客名称"/>                               
                              </div>
                           </div>
                           <div class="form-group">
                           ...
                           <div class="form-group">
                              <label  class="col-md-2 control-label">顾客联系人</label>
                              <div class="col-md-10">
                                 <form:input path="contactPerson" class="form-control" placeholder="顾客联系人"/>
                              </div>
                           </div>
                           <div class="form-group">
                              <label  class="col-md-2 control-label">顾客联系电话</label>
                              <div class="col-md-10">
                                 <form:input path="customerTele" class="form-control" placeholder="顾客联系电话"/>
                              </div>
                           </div>
                           <div class="form-group">
                              <label  class="col-md-2 control-label">顾客邮箱</label>
                              <div class="col-md-10">
                                 <form:input path="customerEmail" class="form-control" placeholder="顾客联系邮箱"/>
                              </div>
                           </div>
                           <div class="form-group">
