...
<body class="page-header-fixed">
                  ...
                  <div class="portlet-body form">
                     <form:form modelAttribute="contentModel" class="form-horizontal" method="POST">
                        <div class="form-body">
                              ...
                              <div class="col-md-10">
                                 <form:input path="id" name="id" id="id" class="form-control" placeholder="编号"/>
                              </div>
                           </div>
   ...
   <script type="text/javascript">
   	...
   	var pics= document.getElementById("imagesname").value;
   	var piclist= new Array();
   	piclist=pics.split(",");
   	//alert(piclist);
   	$("#images").fileinput({
        language: 'zh', //设置语言
        uploadUrl:"../productedit/"+document.getElementById("id").value+"/uploadimage2", //上传的地址
