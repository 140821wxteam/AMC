                     ...
                     <form:form modelAttribute="contentModel" class="form-horizontal" method="POST">
                        <div class="form-body">
                           <div class="form-group">
                              ...
                              <div class="col-md-10">
                                 <form:input path="vendorId" class="form-control" placeholder="供应商编号"/>
                              </div>
                           </div>
                           <div class="form-group">
                              <label  class="col-md-2 control-label">供应商名称</label>
                              <div class="col-md-10">
                                 <form:input path="vendorName" class="form-control" placeholder="供应商名称"/>                               
                              </div>
                           </div>
                           <div class="form-group">
                              <label  class="col-md-2 control-label">供应商地址</label>
                              <div class="col-md-10">
                                 <form:input path="vendorAddr" class="form-control" placeholder="供应商地址"/>
                              </div>
                           </div>
                           <div class="form-group">
                              <label  class="col-md-2 control-label">供应商联系人</label>
                              <div class="col-md-10">
                                 <form:input path="contactPerson" class="form-control" placeholder="供应商联系人"/>
                              </div>
                           </div>
                           <div class="form-group">
                              <label  class="col-md-2 control-label">供应商联系电话</label>
                              <div class="col-md-10">
                                 <form:input path="vendorTele" class="form-control" placeholder="供应商联系电话"/>
                              </div>
                           </div>
                           <div class="form-group">
                              <label  class="col-md-2 control-label">供应商邮箱</label>
                              <div class="col-md-10">
                                 <form:input path="vendorEmail" class="form-control" placeholder="供应商联系邮箱"/>
                              </div>
                           </div>
                           <div class="form-group">
