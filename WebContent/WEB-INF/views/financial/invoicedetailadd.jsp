                     ...
                     <form:form modelAttribute="contentModel" class="form-horizontal" method="POST">
                        <div class="form-body">
                           <div class="form-group">
                              ...
                              <div class="col-md-10">
                                 <form:input path="invoiceId" name="invoiceId" class="form-control" placeholder="发票编号"/>                                 
                              </div>
                           </div>
                           <div class="form-group">
                              <label  class="col-md-2 control-label">发票明细编号</label>
                              <div class="col-md-10">
                                 <form:input path="invoicedetailId" name="invoicedetailId" class="form-control" placeholder="发票明细编号"/>                               
                              </div>
                           </div>
                           <div class="form-group">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-md-10">
                                 <form:input path="amount" name="amount" id="amount" class="form-control" placeholder="数量" onchange="figure()"/>
                              </div>
                           </div>
